    ...
    <main id="section-about">
      ...
      <div className="about-item about-now">
        ...
        <div className="content">
          ...
          <p>We have trained over 50 students in handling telescopes over the course of years. We also organize student talks, which are followed by discussions where students get to interact and learn from each other. These discussions and sessions are what hold NAC together.</p>
          <p>We are proud to have assisted in the Observation Test in the 10th International Olympiad in Astronomy and Astrophysics (IOAA). It is only natural that we collaborate with other Astronomy clubs and even other clubs of our institute, like the Arts Club or Literary Club, to promote a healthy learning environment, and approach astronomy in many possible ways.</p>
        </div>
      </div>
    </main>
  )
