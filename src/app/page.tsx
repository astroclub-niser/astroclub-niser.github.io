    ...
    <main>
      ...
      <div id="home-gallery" className='section-home'>
        ...
        <div className="gallery-grid">
          {picsData.map(({ id, object, image, description }: AstroProps) => (
      ...
      <div id="newsletter" className='section-home'>
        ...
        <div className="newsletter-content">
          ...
          <button className='btn'><a target='_blank' href='https://drive.google.com/file/d/1y5bRlFItbBAT5j9ICuRiAE8K-VgqpDqF/view?usp=sharing'>Read Latest</a></button>
