  ...
  return (
    <main>
      ...
      <div id="home-gallery" className='section-home'>
        ...
        <button id='btn'><Link href="/gallery">See More</Link></button>
      </div>

      <div id="newsletter" className='section-home'>
        <Image src={'/Kshitij_Dec_2020.jpg'} alt='event horizon' width={300} height={500}></Image>
        <div className="newsletter-content">
          ...
          <button id='btn'><a href=''>Read Latest</a></button>
      ...
      <div id="magazine" className='section-home'>
        <div className="magazine-content">
          ...
          <p></p>
          <button id='btn'><Link href="/magazine">Know More</Link></button>
          <button id='btn'><a href=''>Contribute</a></button>
        </div>
        <div className="magazine-previews">
          <figure>
            <Image src={'/Kshitij_Dec_2020.jpg'} alt='event horizon' width={200} height={460}></Image>
